...
class Attribute:
    ...
    def __init__(self, key, bb_sets, bins=100):
        ...
        mout.debug(f"Getting values for Attribute({key})...")
    ...
    def __call__(self, value):
        ...
        if isinstance(value, CompoundSet) or "CompoundSet" in str(type(value)):
...
class Scorer:
    ...
    * BBSs sorted by score
    ...
    def __call__(self, bbs):
        return self.score(bbs)
